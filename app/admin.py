...
from .models import DTM_Practise, Fanlar, IELTS_Reading, ReadingTest, IELTSListeningQuestion, Milliy_Sertifikat, IELTS_writing, SATQuestion, Davlat_Univer, Xorijiy_Univer, Xususiy_Univer, UserTestResult, ReadingTest, ListeningTest,Sat
